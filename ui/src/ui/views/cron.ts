    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="list-main">
        ...
        ${
          silent
            ? html`
                <div class="muted" style="font-style: italic">Silent (no output unless thresholds triggered)</div>
              `
            : nothing
        }
      </div>
    ...
    <div class="muted" style="margin-top: 12px">
      ...
      ${
        selectedJob && !selectedJob.enabled
          ? html`
              <div style="margin-top: 4px; color: var(--color-warning)">Job is disabled</div>
            `
          : nothing
      }
    </div>
